//original: https://api.map.baidu.com/library/Heatmap/2.0/docs/symbols/BMapLib.HeatmapOverlay.html
...
(function (b, c, a) {
    ...
    var h = (function j() {
        ...
        function m(t) {
            ...
            s.style.cssText = u.style.cssText =
            ...
            t.on("extremachange", function (u) {
                r._config.onExtremaChange &&
                    r._config.onExtremaChange({
                        ...
                        max: u.max,
                        gradient:
                            r._config.gradient || r._config.defaultGradient,
                    });
            });
            q.setCoordinator(t);
        };
